    ...
    <main className='w-full lg:w-2/4'>
         <form method="POST" className='w-full'>
            ...
            <div className='flex flex-col m-5'>
                ...
                <input className=' bg-zinc-700 border-none rounded-lg text:xs lg:text-l' onChange={(e) => setFullname(e.target.value)} value={fullname} type="text" id='fullname' name='fullname' required/>
            </div>

            <div className='flex flex-col m-5'>
                <label className='font-semibold text-l lg:text-xl' htmlFor="businessName">Nombre de la empresa</label>
                <input className=' bg-zinc-700 border-none rounded-lg text-l' type="text" onChange={(e) => setBusiness(e.target.value)} value={business} id='businessName' name='businessName' placeholder='opcional'/>
            </div>

            <div className='flex flex-col m-5'>
                <label className='font-semibold text-l lg:text-xl' htmlFor="email">Correo Electronico</label>
                <input className=' bg-zinc-700 border-none rounded-lg text-l' type="email" onChange={(e) => setEmail(e.target.value)} value={email} id='email' name='email' placeholder='ejemplo@mail.com' required/>
            </div>
            ...
            <div className='flex flex-col m-5'>
                ...
                <textarea className=' bg-zinc-700 border-none rounded-lg text-l h-28 min-h-[32px] max-h-48' onChange={(e) => setMessage(e.target.value)} value={message} id='message' name='message' placeholder='Escriba la consulta aqui' required/>
            </div>
